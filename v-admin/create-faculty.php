        ...
        <div class="row stu_adm_row">
            <div class="col-lg-6">
            	<form role="form" action="v-includes/functions/function.create-faculty.php" method="post">
	                ...
	                <input type="hidden" name="action" value="facultyForm" />
                    <button type="submit" class="btn btn-success btn-lg">Create Faculty</button>
                </form>
            </div>
            <!-- /.col-lg-6 -->
            <div class="col-lg-6">	
            	<form role="form" id="facinfo" action="v-includes/functions/function.create-faculty.php" method="post" enctype="multipart/form-data">
	                ...
	                <div class="form-group">
	                    <label class="cs_form_label">Add Course</label>
	                    <select class="form-control cs_form_textbox" name="course[]" id="curri_course_excel" multiple="multiple">
                    ...
                    <button id="facfile" type="submit" class="btn btn-success btn-lg">Submit</button>
                </form>
            </div>
            <!-- /.col-lg-6 -->
