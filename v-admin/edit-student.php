	...
	<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 class="cs_page_info">You can edit data about student.</h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <?php
		...
		?>
        <?php
			//get student user id from get method
			$user_id = $GLOBALS['_GET']['uid'];
			//get values from bll
			$getValues = $BLL_Obj->getUserInfo('students_info','user_id',$user_id);
		?>
        <!-- /.row -->
        <div class="row stu_adm_row">
            ...
            <!-- /.col-lg-6 -->
            <div class="col-lg-6">	
            	<form action="v-includes/functions/function.edit-student.php" method="post">
                    ...
                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
                    <input type="hidden" name="op" value="stu_cred" />
