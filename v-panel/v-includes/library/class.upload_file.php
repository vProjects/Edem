...
class FileUpload{
	...
	*/
	private $allowed_filetypes = array('.ods','.xls','.xlsx','.jpg','.jpeg','.png','.gif','.JPG','.JPEG','.PNG','.GIF');
	private $allowed_documents_filetypes = array('.ods','.xls','.xlsx','.jpg','.jpeg','.png','.gif','.txt','.pdf','.psd','.rtf','.sql','.zip','.rar','html','.JPG','.JPEG','.PNG','.GIF');
